...
> **Nota:** este projeto foi desenvolvido para o Desafio Técnico Full Stack da seleção V-Lab (CIn-UFPE). Ele é executado localmente via Docker Compose — não há deploy público.
